  ...
  return (
    <>
      <PageHeader
        ...
        description="Deep-dive into revenue, student growth, and branch performance."
        actions={
          <>
      ...
      <div className="print-area">
        ...
        <div className="hidden print:block border-b-2 border-black pb-4 mb-6">
          <div className="flex justify-between items-start">
            <div>
              ...
              <p className="text-sm text-gray-700">
                Phone: +977 01-4567890 | Email: info@drivesiksha.com.np
              </p>
            </div>
          ...
          <div className="grid grid-cols-4 gap-2 mt-4 text-xs border border-gray-300 p-3 bg-gray-50 rounded">
            <div>
              ...
              <strong className="text-black">{formatNPR(totalRev)}</strong>
            </div>
            <div>
              <span className="text-gray-600">Total Student Registrations:</span>{" "}
              <strong className="text-black">{totalReg}</strong>
            </div>
            <div>
              <span className="text-gray-600">Avg. Monthly Revenue:</span>{" "}
              <strong className="text-black">{formatNPR(avgRev)}</strong>
            </div>
            <div>
              <span className="text-gray-600">Top Performing Branch:</span>{" "}
              <strong className="text-black">Baneshwor</strong>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 gap-3 sm:gap-4 lg:grid-cols-4 mb-4 no-print items-stretch">
          ...
          <StatCard
            ...
            icon={Users}
            tone="brand"
            hint="New registrations"
            className="h-full"
          />
          <StatCard
            label="Avg. Monthly Revenue"
            value={formatNPR(avgRev)}
            icon={TrendingUp}
            tone="sky"
            className="h-full"
          />
        ...
        <div className="hidden print:block mt-6">
          <h3 className="text-base font-bold text-black mb-2 border-b pb-1">
            Monthly Revenue & Intake Summary (Bikram Sambat)
          </h3>
                ...
                return (
                  <tr key={m.month} className="border-b border-gray-200">
                    ...
                    <td className="p-2 border-r border-gray-200">
                      {formatNPR(Math.round(m.revenue * 0.5))}
                    </td>
                    <td className="p-2 border-r border-gray-200">
                      {formatNPR(Math.round(m.revenue * 0.3))}
                    </td>
